INSERT INTO app_user (email, hash_password, first_name, last_name, subscriber, role)
VALUES
    ('user1@example.com', '$2a$10$wMOV3vrXwQmwmNQx0qEOxuICbS/6HpTa.lruJU2w5qjAkYV2P1ABK', 'John', 'Doe', true, 'ADMIN'),        -- password1
    ('user2@example.com', '$2a$10$YsYRGVPbpTKsFYNqM6y//ef4cdu2aPGnKMkFz0kIFpTw8.D/boi3i', 'Jane', 'Smith', false, 'USER'),     -- password2
    ('user3@example.com', '$2a$10$Cf19F9hlJVRbU9DdFCfgROGGkmc3CDUEl1/9xI3uXcKkYr8iDRHMy', 'Alice', 'Johnson', true, 'USER'),   -- password3
    ('user4@example.com', '$2a$10$ayVB2ZBv/ZR9AFeCy73gvOrhOCVejbPsg50Ufi9dIgBTTRjxVAca6', 'Bob', 'Brown', false, 'USER'),      -- password4
    ('user5@example.com', '$2a$10$sMQqUBfqtF0baPzehx9AVuQNPUni4t45/pWztuixqNupYlXf0oz6W', 'Emma', 'White', true, 'USER');      -- password5
